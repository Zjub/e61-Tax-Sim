...
SIH2019_Person$over_60 <- ifelse(SIH2019$AGEEC > 59, 1, 0)
...
SIH2019_Person_Q1 <- subset(SIH2019_Person, SIH2019_Person$QTRITRWH == 1)
...
policy_date1 <- "Q3_2019" # XXXX Replace this with a function call.
...
SIH2019_Person_Q1 <- subset(SIH2019_Person_Q1, SIH2019_Person_Q1$AGEEC < 66)
...
for (i in 1:nrow(SIH2019_Person_Q1)) {
  values <- SIH2019_Person_Q1[i, column_names1]
  actual_values <- SIH2019_Person_Q1[i, column_names2]
