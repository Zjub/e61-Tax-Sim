...
calc_family_benefit <- function(child_age,gross_fam_income,work_income,taxable_benefit){
  ...
  highest_hh_income <- max(partner_earnings *(1+super_cont_rate) , work_income *(1+super_cont_rate) + taxable_benefit)
  lowest_hh_income <- min(partner_earnings *(1+super_cont_rate) , work_income *(1+super_cont_rate) + taxable_benefit)
